...
3、https://github.com/[Username]/nav/settings/secrets/actions/new  添加申请的token， name填写 `TOKEN` 大写。

4、打开 https://github.com/[Username]/nav/actions 点击 `绿色按钮`

5、务必修改项目配置文件 [nav.config.ts](nav.config.ts)

6、5分钟后打开 https://[Username].github.io/nav 就能看到一个非常强大的导航网站了。
